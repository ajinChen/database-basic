...
// $ represent the whole array, $$ represent the elem of array (go into)
...
db.world_bank_project.aggregate({$group:{_id :"$countrycode", count:{$sum:1}}},
                                {$project:{'count':true, 'countrycode':'$_id', '_id':false}}) 
...
db.world_bank_project.aggregate([{$project: {'id': true,
                                             'borrower': true,
                                             '_id': false,
